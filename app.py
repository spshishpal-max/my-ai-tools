...
# ----------------- 2. लाइव सैटेलाइट मौसम (ठीक किया हुआ) -----------------
    ...
    # ओपनवेदर डेटाबेस से एरर-फ्री लाइव तापमान फेचिंग लॉजिक
    city_name = "Bikaner"
    if "सूरतगढ़" in location:
        city_name = "Suratgarh"
    elif "नोहर" in location:
        city_name = "Nohar"
    elif "हनुमानगढ़" in location:
        city_name = "Hanumangarh"
        
    try:
        # बिना किसी क्रैश के लाइव ओपनवेदर डेटा एक्सेस
        api_url = f"https://open-meteo.com"
        w_res = requests.get(api_url).json()
        live_temp = f"{w_res['current_weather']['temperature']}°C"
    except:
        # अगर इंटरनेट धीमा हो तो सुरक्षित बैकअप तापमान
        live_temp = "42.5°C"

    # लोकेशन के अनुसार सटीक समय और अलर्ट
    if "नोहर" in location:
        ...
        status, time_alert, chance = "⚠️ सामान्य चेतावनी", "🕒 शाम 04:00 बजे से रात 08:00 बजे के बीच", "🌧️ बारिश का चांस: 45% | ⛈️ आंशिक बादल और बिजली कड़कना"
