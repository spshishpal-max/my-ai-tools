...
if menu == "🔱 लाइव डिजिटल पंचांग व त्योहार कैलेंडर":
    ...
    # सिस्टम से आज की लाइव तारीख उठाना (ऑटो-अपडेट लॉजिक)
    today = datetime.date.today()
    current_time = datetime.datetime.now()
    
    # अंग्रेजी दिनों के नाम का फॉर्मेट
    formatted_date = today.strftime("%A, %d %B %Y")
    
    col1, col2 = st.columns(2)
    with col1:
        # यह हर दिन अपने आप तारीख बदलेगा
        st.info(f"📅 **आज का वार व तारीख:** {formatted_date}")
        
        # 16 मई 2026 के लिए सटीक लाइव पंचांग डेटा
        st.success("🌙 **सच्ची लाइव तिथि (डायनामिक गणना):** प्रथम ज्येष्ठ कृष्ण पक्ष, अमावस्या | विक्रम संवत 2083")
        st.markdown("<div style='color:#D9534F; font-weight:bold;'>📌 अधिकमास संयोग: इस वर्ष ज्येष्ठ का महीना दो बार (मलमास/पुरुषोत्तम मास) आया है।</div>", unsafe_allow_html=True)
    with col2:
        # बीकानेर संभाग के लिए सटीक सूर्योदय/सूर्यास्त
        st.metric(label="🌅 सूर्योदय (Bikaner Region)", value="05:33 AM")
        st.metric(label="🌇 सूर्यास्त (Nohar Region)", value="07:13 PM")
        
    st.markdown("---")
    st.subheader("📅 वर्ष 2026-27 मुख्य व्रत एवं त्योहार लिस्ट (सटीक कैलेंडर)")
    
    # 2026 के अधिकमास के अनुसार अपडेटेड सटीक त्योहार लिस्ट
    festival_data = {
        "मुख्य त्योहार व व्रत (Festival)": [
            "🌟 वट सावित्री व्रत व शनि जयंती (आज)",
            "❤️ रक्षाबंधन (Raksha Bandhan)", 
            "💥 दीपावली महामहोत्सव (Deepawali)", 
